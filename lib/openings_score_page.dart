...
class CountingScoreOpenings extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String totalVariants = 'X'; // Przykładowa wartość, zmień na faktyczną liczbę wariantów
      ...
      body: Column(
        children: <Widget>[
          Padding(
            ...
            child: Text('Overall result: 0/$totalVariants', style: TextStyle(fontSize: 20, color: Colors.white)),
          ),
          Expanded(
            child: ListView(
              children: <Widget>[
            ...
            child: Row(
              children: [
                ...
                Checkbox(
                  ...
                  fillColor: MaterialStateProperty.all(Colors.grey), // Kolor tła checkboxa
                ),
              ],
            ),
          ),
